...
class WarehousePredictor:
    ...
    if item_id_input > 0:
        ...
        # Replicate the scalar value to match the length of expiry
        item_predicted_sales = np.full_like(expiry, item_predicted_sales)

        plt.figure(figsize=(10, 6))
        plt.plot(expiry, item_predicted_sales * 30, marker="o", color="blue", label="Predicted Sales")
        plt.xlabel("ExpiryDate")
