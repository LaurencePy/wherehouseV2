...
sales_predict_data = pd.read_csv(r"C:\Users\laeat\Documents\Coding\wherehouse database stuff\sales_predict_data.csv")
...
normalise_data = concatenation_with_predict_data[["SalesWeek", "SalesMonth", "days_to_expire", "predict_sales"]]
